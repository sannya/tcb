...
function devdm_theme_options()
{
    ...
    <div class="wrap">
        ...
        <div class="dm-logo-wrap"><a href="<?php echo $developer_uri ?>" target="_blank"><img src="<?php echo $logo; ?>"
                                                                                              class="dm-logo"
                                                                                              title="Created by Danny Machal @ DevDm.com"/></a>
        </div>
        ...
        <form action="options.php" method="post">
            ...
            <table cellpadding='10'>
                ...
                <tr valign="top">
                    <th scope="row"><?php _e('Right Sidebar', 'devdmbootstrap3'); ?></th>
                    <td>
                ...
                <tr valign="top">
                    <th scope="row"><?php _e('Right Sidebar Size', 'devdmbootstrap3'); ?></th>
                    <td>
                ...
                <tr valign="top">
                    <th scope="row"><?php _e('Left Side Bar', 'devdmbootstrap3'); ?></th>
                    <td>
                ...
                <tr valign="top">
                    <th scope="row"><?php _e('Left Sidebar Size', 'devdmbootstrap3'); ?></th>
                    <td>
                        <?php foreach ($dm_sidebar_sizes as $sizes) : ?>
                            <input type="radio" id="<?php echo $sizes['value']; ?>"
                ...
                <tr valign="top">
                    <th scope="row"><?php _e('Show Header', 'devdmbootstrap3'); ?></th>
                    <td>
                        <input type="checkbox" id="show_header" name="dm_options[show_header]"
                               value="1" <?php checked(true, $settings['show_header']); ?> />
                        <label
                            for="show_header"><?php _e('Show The Main Header in the Template (logo/sitename/etc.)', 'devdmbootstrap3'); ?></label>
                    </td>
                </tr>

                <tr valign="top">
                    <th scope="row"><?php _e('Show Post Meta', 'devdmbootstrap3'); ?></th>
                    <td>
                        <input type="checkbox" id="show_postmeta" name="dm_options[show_postmeta]"
                               value="1" <?php checked(true, $settings['show_postmeta']); ?> />
                        <label
                            for="show_postmeta"><?php _e('Show Post Meta data (author, category, date created)', 'devdmbootstrap3'); ?></label>
                    </td>
                </tr>

                <tr valign="top">
                    <th scope="row"><?php _e('Give Danny His Credit?', 'devdmbootstrap3'); ?></th>
                    <td>
                        <input type="checkbox" id="author_credits" name="dm_options[author_credits]"
                               value="1" <?php checked(true, $settings['author_credits']); ?> />
                        <label
                            for="author_credits"><?php _e('Show me some love and keep a link to DevDm.com in your footer.', 'devdmbootstrap3'); ?></label>
                    </td>
                </tr>
            ...
            <p class="submit">
                <input name="Submit" type="submit" class="button-primary"
                       value="<?php esc_attr_e('Save Changes', 'devdmbootstrap3'); ?>"/>
            </p>
